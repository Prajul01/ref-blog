...
class OutsourcingController extends BackendBaseController
{
    protected $route ='admin.outsourcing.';
    protected $panel ='Outsourcing';
    protected $view ='backend.outsourcing.';
    protected $title;
    protected $model;
    function __construct(){
        $this->model = new Outsourcing();
    }
    /**
